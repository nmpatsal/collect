...
public class FormLoaderTask extends AsyncTask<String, String, FormLoaderTask.FECWrapper> {
    ...
    protected FECWrapper doInBackground(String... path) {
        ...
        if (formBin.exists()) {
            ...
            Timber.i("Attempting to load %s from cached file: %s", formXml.getName(),
        ...
        try {
            ...
            if (mInstancePath != null) {
                ...
                if (shadowInstance.exists() && (shadowInstance.lastModified()
                    ...
                    Timber.w("Loading instance from shadow file: %s",
    ...
    private void loadExternalData(File mediaFolder) {
        ...
        if (zipFiles != null) {
            ...
            for (File zipFile : zipFiles) {
                ...
                if (!deleted) {
                    Timber.w("Cannot delete %s. It will be re-unzipped next time. :(",
                            zipFile.toString());
                }
            }
        }
